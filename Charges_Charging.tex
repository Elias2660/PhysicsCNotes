...
\begin{itemize}
    ...
    \item Pick infinitesimal charge element and define the infinitesimal field from the infinitesimal charge
...
Let's now split the disk into rings of radius $r \in (0 < r < R)$, thickness $\delta r$ and charge $\delta q = \sigma \delta A$
$$\delta A = 2 \pi r \delta r$$
$$\delta q = \sigma \delta A = 2 \pi r \sigma \delta r$$

\textbf{\emph{Step 2}: Finding an infinitesimal field from infinitesimal charge}

$$\delta \vec{E} = \frac{z \delta q}{4 \pi \epsilon (z^2 + r^2) ^{\frac{3}{2}}} = \frac{z \sigma}{4 \pi \epsilon} \frac{2r \pi \delta r}{(z^2 + r^2) ^ {\frac{3}{2}}}=  \frac{z \sigma }{4 \epsilon} \frac{2r\delta r}{(z^2 + r^2) ^ {\frac{3}{2}}}$$
