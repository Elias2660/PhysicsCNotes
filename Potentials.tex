...
This can also be related to potentials, through the calc idea of differentiation (iirc)

$$\Delta \cdot E = \frac{\rho}{\epsilon_0}$$

These equations, though, are only good/useful if you have a good gaussian surface

\subsection{Nice Guassian Surfaces}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.28\textwidth]{figures/GuassSetups.png}
    \caption{Guassian setup}
\end{figure}
