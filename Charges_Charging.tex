...
\medskip
\textbf{Note}: Elementary charges are done because they are the smallest stable charge. You can get quarks, but will reform to these particles.
...
\[
\frac{1.5 \, \text{m} \times \left(6.023 \times 10^{23} \, \text{particles} \, \text{per} \, \text{m}\right)}{1 \times 10^6 \, \text{particles}} \times \frac{1.6 \times 10^{-19} \, \text{C}}{e} = 0.144 \, \text{C}
\]
