...
\begin{enumerate}
    \item We don't want to use $k$ anymore. Instead we use $\frac{1}{4 \pi \epsilon}$ $\epsilon$ represents the permittivity of a material \footnote{the ablity of a particle to hold enerty at a specific field without breaking down}. For vacuums, the permittivity, or $\epsilon_0$, is equal to $8.85 \times 10 ^ {-12} \frac{\text{C}^2}{\text{Nm}^2}$
