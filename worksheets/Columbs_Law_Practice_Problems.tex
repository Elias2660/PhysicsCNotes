...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.2\textwidth]{figures/Q8.png}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{figures/Q19.png}
\end{figure}
...
\section*{21}
\emph{A nonconducting sphrical shell, with an inner radius of 4.0 cm and an outer radius of 6.0 cm, has charge spread nonuniformly through its volume between its inner and outer surfaces. The \textbf{volume charge density} p is the charge per unit volume, with the unit coulomb per cubic meter. For this shell $p = \frac{b}{r}$, where r is the distance in meters from the center of the shell and $b = 3.0  \frac{\mu \text{C}}{\text{m}^2}$. What is the net charge of the shell?} \\
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{figures/Q32.png}
\end{figure}
...
$$= 2.885 \times 10^{-18} \text{C} =\boxed{ 13 e}$$ \\
