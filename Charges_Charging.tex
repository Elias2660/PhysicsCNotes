...
where $\hat {r}$ is vector pointing to the other charge, making it so that when its positive, the charge . Remember, $\boxed{\epsilon_0 = 8.85 \times 10 ^ {-12} \frac{\text{C}^2}{\text{Nm}^2}}$ [this is also on the reference table]
